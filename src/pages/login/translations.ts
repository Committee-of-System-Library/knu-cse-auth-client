...
export const loginTranslations: Record<Language, {
  ...
  ko: {
    ...
    footerDept: '경북대학교 IT대학 컴퓨터학부 학생회',
    footerAddress: '우)41566 대구광역시 북구 대학로 80 / IT대학 융복합관 102호 학생회실 (건물번호: 415)',
    footerTel: 'TEL. 학부: 950-5550, 대학원 : 950-6420',
    footerFax: 'FAX. 053-957-4846',
    footerEmail: 'E-mail. scse@knu.ac.kr',
    footerCopyright: 'Copyright© 2026, 경북대학교 IT대학 컴퓨터학부 학생회',
  },
  en: {
    ...
    footerDept: 'KNU IT College, CSE Student Council',
    footerAddress: '80 Daehak-ro, Buk-gu, Daegu 41566, Korea / IT Convergence Building Room 102 (No. 415)',
    footerTel: 'TEL. Dept: 950-5550, Grad: 950-6420',
    footerFax: 'FAX. 053-957-4846',
    footerEmail: 'E-mail. scse@knu.ac.kr',
    footerCopyright: 'Copyright© 2026, KNU CSE Student Council',
  },
}
